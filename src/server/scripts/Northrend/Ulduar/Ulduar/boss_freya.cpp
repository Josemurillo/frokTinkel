...
enum FreyaSpells
{
    ...
    SPELL_IRONBRANCH_ESSENCE                     = 62713,
    SPELL_BRIGHTLEAF_ESSENCE                     = 62968,
            ...
            void EnterCombat(Unit* who)
            {
                ...
                for (uint8 n = 0; n < 3; ++n)
                {
                    ...
                    if (Elder[n] && Elder[n]->isAlive())
                    {
                        ...
                        Elder[n]->AddAura(SPELL_IRONBRANCH_ESSENCE,me);
                ...
                {
                    Elder[0]->AddAura(SPELL_BRIGHTLEAF_ESSENCE, me);
                ...
                {
                    Elder[2]->AddAura(SPELL_IRONBRANCH_ESSENCE, me);
