...
{
    SEC_PLAYER         = 0,
	SEC_VIP			   = 1,   // Cuentas vip con acceso a .save, .bank y otros.
	SEC_INICIADO       = 2,   // Tickets y iniciados en Aura.
    SEC_MODERATOR      = 3,   // Moderadores con permisos para banear.
	SEC_GAMEMASTER     = 4,   // ATENCION , TESTEOS Y EVENTOS. DEJAMOS EL 5 POR SI QUEREMOS SEPARAR 2 RANGOS MAS ADELANTE
    SEC_SUPERGAMEMASTER = 6,  // RESPONSABLES DE EQUIPOS Y FUNCIONAMIENTO DE SERVIDOR. DEJAMOS EL 7 POR SI QUEREMOS METER 2 TIPOS DE RESPONSABLES.
	SEC_ADMINISTRATOR  = 8,   // ADMIN.
