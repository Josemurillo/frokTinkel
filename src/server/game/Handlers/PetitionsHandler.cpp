...
void WorldSession::HandlePetitionRenameOpcode(WorldPacket & recv_data)
{
    ...
    if (type == GUILD_CHARTER_TYPE)
    {
        ...
        if (sObjectMgr->IsReservedName(newName) || !ObjectMgr::IsValidCharterName(newName) || (sWorld->getBoolConfig(CONFIG_WORD_FILTER_ENABLE) && !sWordFilterMgr->FindBadWord(newName).empty()))
        {
